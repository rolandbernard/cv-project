\begin{figure}
  ...
  \begin{tikzpicture}[
    ...
    node distance=1.5, every path/.style={opacity=0.25}
  ]
    \node [base_node, yshift=6, xshift=6, opacity=1] at (0,0) {\includegraphics[width=15mm]{figures/examples/example1.png}};
    \node [base_node, yshift=4, xshift=4, opacity=1] at (0,0) {\includegraphics[width=15mm]{figures/examples/example2.png}};
    \node [base_node, yshift=2, xshift=2, opacity=1] at (0,0) {\includegraphics[width=15mm]{figures/examples/example3.png}};
    \node [base_node, opacity=1] (video_box) at (0,0) {\includegraphics[width=15mm]{figures/examples/example4.png}};
    \node[below_label, below=0 of video_box, opacity=1] (video_label) {Multi-View Videos};

    \node [base_node, right=1.3 of video_box, yshift=6, xshift=6, opacity=1] {\includegraphics[width=15mm]{figures/examples/example1.png}};
    \node [base_node, right=1.3 of video_box, yshift=4, xshift=4, opacity=1] {\includegraphics[width=15mm]{figures/examples/example2.png}};
    \node [base_node, right=1.3 of video_box, yshift=2, xshift=2, opacity=1] {\includegraphics[width=15mm]{figures/examples/example3.png}};
    \node [base_node, right=1.3 of video_box, opacity=1] (detections_box)  {\includegraphics[width=15mm]{figures/examples/example4_pred.png}};
    \node[below_label, below=0 of detections_box, opacity=1] (detections_label) {2D Detections};
    ...
    \draw[flow, opacity=1] (video_box) -- (detections_box)
      node[arrow_label, pos=0.5, below, opacity=1] {YOLO};
