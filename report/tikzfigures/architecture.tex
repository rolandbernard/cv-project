\begin{figure*}[ht!]
  ...
  \begin{tikzpicture}[
    ...
    \node[below_label, below=0 of predict_box, xshift=-20] (predict_label) {Predict 3D State};
    ...
    \node[below_label, below=0 of merge_box, xshift=20] (merge_label) {Merge Old and New Tracks};
  ...
  \end{tikzpicture}
  \caption{Architecture overview of the developed tracking system. Images are passed through a 2D pose estimation model to obtain the detections. These are matched against the predictions and the other cameras detections. New tracks are initialized using triangulation, and old tracks updated using Kalman filter update.}
